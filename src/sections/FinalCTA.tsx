        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div {...fadeUp} transition={{ duration: 0.8 }}>
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 tracking-tight leading-tight">
              ...
              <span className="gold-accent">Start Your Visa Today.</span>
            </h2>
            
            <p className="text-lg text-white/70 mb-8 leading-relaxed">
              Fill in your details and our visa experts will contact you within 
              24 hours with a personalized eligibility assessment and clear next steps.
            </p>
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { icon: '📋', text: 'Free eligibility assessment' },
            ...
            <div className="flex flex-wrap gap-4">
              <a href="tel:+971000000000" className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/10 text-white/80 hover:bg-white/15 transition">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-sm">+971 XX XXX XXXX</span>
              </a>
              <a href="https://wa.me/971000000000" className="flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/30 transition">
          ...
          >
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-2xl shadow-black/20">
              {submitted ? (
                ...
                <>
                  <div className="mb-6">
                    <h3 className="text-xl font-bold text-slate-900 mb-1">Free Eligibility Check</h3>
                    <p className="text-slate-500 text-sm">Get a clear answer about your Schengen visa today.</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <p className="text-xs text-slate-400 text-center">
                      By submitting, you agree to our Privacy Policy and consent to be contacted about your visa inquiry.
                    </p>
                  </form>
                </>
              )}
